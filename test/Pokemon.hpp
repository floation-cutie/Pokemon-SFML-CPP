...
public:
  ...
  //考虑属性之间的碰撞
  virtual int attack(std::shared_ptr<Pokemon> opptr, bool autofight = true) = 0;
};
...
public:
  ...
  // runtime battle
  virtual int attack(const std::shared_ptr<Pokemon> opptr,
                     bool autofight = true) override;
